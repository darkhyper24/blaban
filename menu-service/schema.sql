...
(
    ...
    discount_value REAL,
    CONSTRAINT items_category_id_fkey FOREIGN KEY
(category_id)
        REFERENCES category
(category_id)
);

-- Insert some sample data into category
INSERT INTO category
    (category_id, name, category_pic)
VALUES
...
-- Insert some sample data into items
INSERT INTO items
    (item_id, category_id, name, price, is_available, quantity, has_discount, discount_value)
VALUES
